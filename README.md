# Hotkey Editor
This is the source code for this [hotkey editor site](https://hotkeyeditor.pages.dev/).

The interaction and usability was designed by me.
The code was largely written by Claude and is set up to use claude in a docker container.
